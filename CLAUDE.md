...
- Klik = 2% CpS z mnożnikami combo (x5)/frenzy (x7) - zgodne z praktyką "klik jako ułamek produkcji"; przy 1% klik czuł się bezużyteczny późną grą (uwaga usera przy 1.85K/s). Aktywne klikanie 8/s z combo daje ~30-50% bonusu do produkcji.
...
- Zdrapka: XP = max(30, 15 s produkcji) (było 60 s - z mnożnikiem dawało setki tysięcy XP za jedno pociągnięcie).
